...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Button size="lg" variant="outline" className="text-lg px-8 py-4 bg-white" onClick={scrollToDemo}>
              View Live Demo
            </Button>
          </div>
      ...
      {/* Demo Section */}
      <section id="demo-section" className="container mx-auto px-6 py-16 bg-white">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4">See It In Action</h2>
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            Explore our platform with real ESG data from top companies
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-8">
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <span>Apple Inc.</span>
                <Badge className="bg-green-100 text-green-800">AAPL</Badge>
              </CardTitle>
              <CardDescription>Technology • Market Cap: $3.0T</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="text-xs text-gray-500 mt-2">Last updated: 2 hours ago</div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge className="bg-blue-100 text-blue-800">MSFT</Badge>
              </CardTitle>
              <CardDescription>Technology • Market Cap: $2.8T</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Overall ESG Score</span>
                  <span className="text-2xl font-bold text-green-600">82.1</span>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span>Environmental</span>
                ...
                <div className="text-xs text-gray-500 mt-2">Last updated: 1 hour ago</div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <span>Tesla Inc.</span>
                <Badge className="bg-purple-100 text-purple-800">TSLA</Badge>
              </CardTitle>
              <CardDescription>Automotive • Market Cap: $800B</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Overall ESG Score</span>
                  <span className="text-2xl font-bold text-yellow-600">71.3</span>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span>Environmental</span>
                ...
                <div className="text-xs text-gray-500 mt-2">Last updated: 30 minutes ago</div>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center">
          <p className="text-gray-600 mb-6">This is live data from our API. Ready to access 10,000+ more companies?</p>
          <Link href="/signup">
